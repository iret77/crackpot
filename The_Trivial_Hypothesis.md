# The Trivial Hypothesis Nobody Proposes

**Why a singularity-free spacetime might be the simpler assumption**

Christian Wendler — physics-interested layperson
No theory. No refutation. Just a question.

*Discussion Paper — March 2026*
...
> *If a mathematical model produces an entity that is in principle unmeasurable, then that entity is not a physical result, but an artefact of the model. The burden of proof lies with whoever claims the artefact is real.*
...
- Hawking, S. W. (1988): *A Brief History of Time.* Chapter 8: The Origin and Fate of the Universe.
- Boyle, L. & Turok, N. (2018): *CPT-Symmetric Universe.* Physical Review Letters, 121(25).
- Kuhn, T. S. (1962): *The Structure of Scientific Revolutions.* — On paradigmatic inertia in science.
